...
const ChangeIt = () => {
    const content = [
        ...
        {buton:'Reduce Food Waste' ,pic:vegetables, tittle:'Reduce Food Waste', contentt:"By diverting surplus food from landfills, we're <br />reducing harmful methane emissions and<br /> taking a step towards a greener, more <br />sustainable future.", background:"#9A0A0D"},
        {buton:'Community Impact' ,pic:giving, tittle:'Community Impact', contentt:"Join us in making a tangible difference in our <br />communities. Whether you're a restaurant with<br /> excess food or an individual wanting to <br />contribute, SurplusSaver provides the platform<br /> to do so easily and efficiently.", background:"#FE992D"}
    ];
    ...
    const handleclick = ({contindex}) =>{
        ...
        changetextdd.current.innerHTMl = content[contindex].contentt;
