        ...
        <section className={style.fpsec}>
            ...
            <div className={style.fflexp}>
                ...
                <div className={style.dformp}>
                    <p className={style.fpp}>Journey With Us</p>
                    ...
                    <form onSubmit={handlesubmit}>
                        ...
                        <label >
                            ...
                            className={style.fpinputs} value={inputs.name || ""}
                        ...
                        <label >
                            ...
                            className={style.fpinputs} value={inputs.location || ""}
                            onChange={handlechanges}/>
                        </label>
                        <br />
                        <br />
                        ...
                        <label >
                            ...
                            className={style.fpinputs} value={inputs.confirm || ""}
                            onChange={handlechanges}/>
                        </label>
                        <br />
                    ...
                    <p className={style.fpptwo}>Don’t have an account? <Link to='/signin' className={style.fplinkp}>Sign in</Link></p>
                </div>
